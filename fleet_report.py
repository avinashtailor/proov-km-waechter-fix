...
# Written in 2014. Bugs fixed and style modernised 2025.
...
def car_wear(car: dict) -> float:
    """Return wear percentage for a single car, or 0.0 if no service reading exists."""
...
def print_report(fleet: list[dict]) -> None:
    """Load settings, log the report title, and print the nightly fleet summary."""
